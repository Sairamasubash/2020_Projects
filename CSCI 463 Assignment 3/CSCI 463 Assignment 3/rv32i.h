...
// Here are the beginning header guards for the rv32i.h file.
#ifndef rv32i_H
#define rv32i_H
...
class rv32i     // Start of the rv32i class.
{
    // Declaring the public function prototypes for the rv32i class.
public:
    
    // Here are the function prototypes for the rv32i, disasm, and decode functions.
    rv32i(memory *m);
    void disasm(void);
    std::string decode(uint32_t insn) const;
    
    // Here are the render function prototypes.
    ...
    // Here are the get function prototypes.
    ...
    // Here are the newly declared function prototypes.
    ...
    // Declaring the private data members for the rv32i class.
private:
    
    // Here are the regular data members that are required.
    memory * mem;
    uint32_t pc;
    
    // Here are the newly declared regular data members.
    registerfile regs;
    bool halt = false;
    ...
    // Here are the constant data members that are required.
    static constexpr uint32_t XLEN = 32;
    static constexpr int mnemonic_width = 8;
    static constexpr int instruction_width = 35;
    
    // Here are the constant opcodes for the lui, the auipc, the jal, the jalr, and the fence instructions.
    ...
    // Here are the constant opcodes for the B-type instructions.
    ...
    // Here are the constant opcodes for the S-type instructions.
    ...
    // Here are the constant opcodes for the I-type load instructions.
    ...
    // Here are the constant opcodes for the R-type instructions.
    ...
    // Here are the constant opcodes for the I-type alu instructions.
    ...
    // Here are the constant opcodes for the ecall, and the ebreak instructions.
    static constexpr uint32_t opcode_ecall          = 0b1110011;
    static constexpr uint32_t funct7_rs2_ecall      = 0b000000000000;
    static constexpr uint32_t funct7_rs2_ebreak     = 0b000000000001;
    
};     // End of the rv32i class.

#endif     // Here is the ending header guard for the rv32i.h file.
